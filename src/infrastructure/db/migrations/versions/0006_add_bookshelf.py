...
down_revision: str | None = "4de0b4ab42e5"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["book_id"],
            ["books.id"],
            name=op.f("fk__bookshelf_book_association__book_id__books"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["bookshelf_id"],
            ["bookshelf.id"],
            name=op.f("fk__bookshelf_book_association__bookshelf_id__bookshelf"),
            ondelete="CASCADE",
        ),
